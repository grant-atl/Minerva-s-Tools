...
export const tools: Tool[] = [
  { name: "Color Palette Generator", description: "Generate harmonious color palettes with multiple modes", icon: Palette, category: "Colors", tier: 1, route: "/tools/palette" },
  { name: "QR Code Generator", description: "Create customizable QR codes for URLs, WiFi, and more", icon: QrCode, category: "Generators", tier: 1, route: "/tools/qr-code" },
  ...
  { name: "Aspect Ratio Calculator", description: "Simplify ratios and scale dimensions instantly", icon: ArrowsOutSimple, category: "Converters", tier: 1, route: "/tools/aspect-ratio" },
  { name: "px ↔ rem Converter", description: "Quickly convert between px and rem units", icon: ArrowsLeftRight, category: "Converters", tier: 1, route: "/tools/px-rem" },
  ...
  { name: "Lorem Ipsum Generator", description: "Generate placeholder text with fun alternatives", icon: TextAlignLeft, category: "Generators", tier: 1, route: "/tools/lorem-ipsum" },
  ...
  { name: "Color Converter", description: "Convert between HEX, RGB, and HSL instantly", icon: Palette, category: "Colors", tier: 1, route: "/tools/color-converter" },
  ...
  { name: "JSON Formatter & Validator", description: "Validate and format JSON with one click", icon: Code, category: "Data/Dev", tier: 1, route: "/tools/json-formatter" },
  ...
  { name: "UUID Generator", description: "Generate multiple UUID v4 values instantly", icon: QrCode, category: "Data/Dev", tier: 1, route: "/tools/uuid" },
...
export const categoryDescriptions: Record<string, string> = {
  ...
  Converters: "Quick utilities to transform and convert design values.",
};
